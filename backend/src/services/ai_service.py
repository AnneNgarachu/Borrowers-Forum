...
class AIService:
    ...
    def generate_strategy_brief(
        ...
        # 7. Append AI-disclosure disclaimer
        disclaimer = (
            "\n\n---\n\n"
            "*Note: This brief was generated by AI using verified precedent "
            "data. It should be used as a starting point for analysis, not "
            "as definitive negotiation advice. All referenced cases should "
            "be independently verified.*"
        )
        brief_text += disclaimer
